...
EXCLUDE_FILE  = '/home/fenix/.config/rrsync/.rsyncignore' 
DIR_TO_BACKUP = '/home/fenix/docs/tmp/wikidb'
LOG_FILE      = '/home/fenix/.config/rrsync/rrsync.log' 
LOG_AGE       = 'daily'

EMPTY_DIR     = '/home/fenix/.config/rrsync/tmp/' #NEEDS TRAILING SLASH.
# == Options for the remote machine.
SSH_USER      = 'fenix'
SSH_SERVER    = 'localhost'
SSH_PORT      = '' #Leave blank for default (port 22).
BACKUP_ROOT   = '/home/fenix/docs/tmp/wikidb_backup'
...
run_time = Benchmark.realtime do
  begin
    ...
    # Now run the main rsync command:
