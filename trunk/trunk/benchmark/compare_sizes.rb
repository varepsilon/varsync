...
# Benchmark script for comparison of different checksum sizes 
...
RSYNC_ORIG_OPTS_MAIN = "-avv --stats" 
RSYNC_ORIG2_OPTS_MAIN = "-avv --stats" 
RSYNC_RANDOM_OPTS_MAIN = "-avv --stats --random2 --random"
RSYNC_RANDOM2_OPTS_MAIN = "-avv --stats --random2"
#==============================================================================
