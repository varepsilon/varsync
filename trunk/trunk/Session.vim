...
badd +754 receiver.c
badd +1226 generator.c
badd +294 match.c
badd +706 clientserver.c
badd +25 sender.c
badd +1030 main.c
badd +1204 io.c
badd +32 io.h
...
badd +298 rsync.c
badd +33 lib/md5.c
badd +124 ./test/checksum_test.c
badd +1 lib/mdigest.h
badd +215 ~/.viminfo
badd +20 pipe.c
badd +52 loadparm.c
...
45
normal zo
let s:l = 96 - ((18 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
96
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1208 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1208
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 900 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
900
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 591 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
591
